...
const PageNotFound = () => {
  return (
    <div
      className="flex items-center justify-center min-h-screen bg-pink-400  bg-fixed bg-cover bg-bottom error-bg"
      style={{
        ...
        <div className="row">
          <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
            <div className="relative ">
              <h1
                className="relative text-9xl -tracking-widest text-shadow font-sans font-bold"
                style={{ textShadow: "-8px 0 0 rgb(102 123 242)" }}
              >
                <span>4</span>
                <span>0</span>
                <span>4</span>
            ...
            <a className="bg-green-400  px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg cursor-pointer" href="/">
              Goto to Home
            </a>
          </div>
        </div>
